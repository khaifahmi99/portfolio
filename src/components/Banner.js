                    ...
                    <div className="container">
                        ...
                        <div className="col l7 s12 white-text left-align">
                            ...
                            <div className="row"  style={{fontFamily: "Montserrat"}}>
                                <a href="https://www.linkedin.com/in/khaifahmi/" className="btn white black-text margin-btn hoverable waves-effect waves-dark">LinkedIn<i className="fa fa-linkedin-square right" aria-hidden="true" /></a>
                                <a href="https://github.com/khaifahmi99" className="btn white black-text margin-btn hoverable waves-effect waves-dark">Github<i className="fa fa-github right" aria-hidden="true" /></a>
                            </div>
                        </div>
                    </div>
                </div>
