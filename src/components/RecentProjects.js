                ...
                <div className="carousel carousel-slider center" ref={ (carousel) => {this.carousel = carousel} }>
                    ...
                    <div className="carousel-item" href="#one!">
                        <div className="container left-align">
                            <h2 style={{fontFamily: "Montserrat"}}><i class="fa fa-play" aria-hidden="true"></i> Farming Management Mobile and Website Application</h2>
                    ...
                    <div className="carousel-item" href="#two!">
                        <div className="container left-align">
                            <h2 style={{fontFamily: "Montserrat"}}><i class="fa fa-play" aria-hidden="true"></i> Cough Detection on Embedded Device using IoT and Deep Learning</h2>
