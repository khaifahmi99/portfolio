          ...
          <div className="left-align container">
            ...
            <Timeline>
              <Event interval={"2018 – 2021"} title={"Bachelor in Computer Science (Data Science and IoT major)"} subtitle={"Swinburne University of Technology | CGPA: 4.0"}>
                ...
                after taking 16 subjects in 2 years. Majoring in Data Science and Internet of Things (IoT) while introduced to
                other units in Web/Mobile application development, cloud computing, data structures, network and security. Expected
